...
from Vizxer import user_totals_collection, shivuu
...
async def change_time(client: Client, message: Message):
    ...
    if member.status not in ADMINS :
        await message.reply_text('ʏᴏᴜʀ ɴᴏᴛ ᴀ ᴀᴅᴍɪɴ ʜᴇʀᴇ')
        return
    ...
    try:
        ...
        if new_frequency < 100:
            await message.reply_text('ᴛʜᴇ ᴛɪᴍᴇ ғʀᴇᴏ̨ᴜᴇɴᴄʏ ᴍᴜsᴛ ʙᴇ ɢʀᴇᴀᴛᴇʀ ᴛʜᴀɴ ᴏʀ ᴇᴏ̨ᴜᴀʟ ᴛᴏ 100.')
            return
